...
<head>
    ...
    <title>Agenda de Entrevistas - Conexão RH</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    
    <link rel="stylesheet" href="../../../../assets/css/pages/entrevistas/entrevistas.css">
    ...
    <script defer src="../../../../assets/js/pages/entrevista/entrevista.js"></script>
...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li><a href="./entrevistas.blade.php" class="menu-item active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div>
                    ...
                    <p>Gerencie os próximos encontros com seus candidatos.</p>
                </div>
            ...
            <nav class="tabs-nav">
                <button class="tab-btn active" data-target="#proximas">Próximas</button>
                <button class="tab-btn" data-target="#concluidas">Concluídas</button>
                <button class="tab-btn" data-target="#calendario">Calendário</button>
            </nav>

            <div class="tabs-content">
                <div class="tab-pane active" id="proximas">
                    <div class="interviews-list">
                        <div class="interview-card">
                            ...
                            <div class="interview-info">
                                <img src="https://i.pravatar.cc/150?img=32" alt="Candidato">
                                <div class="candidate-details">
                                    <h3>Juliana Martins</h3>
                                    <p>Para a vaga de UI/UX Designer Sênior</p>
                                </div>
                            </div>
                            <div class="interview-tags">
                                <div class="tag tag-stage">Entrevista Técnica</div>
                                <div class="tag tag-status">Agendada - 14:00</div>
                            </div>
                            <div class="interviewers">
                                <img src="https://i.pravatar.cc/150?img=68" alt="Entrevistador 1">
                                <img src="https://i.pravatar.cc/150?img=33" alt="Entrevistador 2">
                            </div>
                        ...
                        <div class="interview-card">
                            ...
                            <div class="interview-info">
                                <img src="https://i.pravatar.cc/150?img=15" alt="Candidato">
                                <div class="candidate-details">
                                    <h3>Carlos Eduardo</h3>
                                    <p>Para a vaga de Desenvolvedor(a) Full-Stack</p>
                                </div>
                            </div>
                            <div class="interview-tags">
                                <div class="tag tag-stage">Triagem RH</div>
                                <div class="tag tag-status">Agendada - 10:30</div>
                            </div>
                            <div class="interviewers">
                                <img src="https://i.pravatar.cc/150?img=11" alt="Entrevistador 1">
                            </div>
                            <div class="interview-actions">
                                <button class="btn btn-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>
                ...
                <div class="tab-pane" id="concluidas">
                    <p style="text-align:center; color: var(--text-light); padding: 2rem;">Nenhuma entrevista concluída recentemente.</p>
                </div>
    ...
    <div class="modal-overlay" id="schedule-interview-modal">
        <div class="modal-container">
            <div class="modal-header">
                <h2>Agendar Nova Entrevista</h2>
                <button class="close-modal-btn" id="close-modal-btn">&times;</button>
            </div>
            <div class="modal-body">
                <form class="form-grid">
                    <div class="form-group full-width">
                        <label for="candidate">Candidato(a)</label>
                        <select id="candidate">
                    ...
                    <div class="form-group full-width">
                        ...
                        <select id="job">
                            ...
                            <option value="UI/UX Designer Sênior">UI/UX Designer Sênior</option>
                            <option value="Desenvolvedor(a) Full-Stack">Desenvolvedor(a) Full-Stack</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="interviewDate">Data da Entrevista</label>
                        <input type="date" id="interviewDate" value="2025-06-16">
                    </div>
                    <div class="form-group">
                        <label for="interviewTime">Horário</label>
                        <input type="time" id="interviewTime" value="14:30">
                    </div>
                    <div class="form-group full-width">
                        <label for="interviewers">Entrevistador(es)</label>
                        <select id="interviewers">
                            <option value="">Selecione o Entrevistador(a)</option>
                            <option value="Ana Oliveira (RH)">Ana Oliveira (RH)</option>
                            <option value="Bruno Santos (Recrutador)">Bruno Santos (Recrutador)</option>
                            <option value="Daniel Ferreira (Gerente de TI)">Daniel Ferreira (Gerente de TI)</option>
                        </select>
                    </div>
                    <div class="form-group full-width">
                        ...
                        <select id="interviewType">
                            ...
                            <option value="Triagem RH">Triagem RH</option>
                    ...
                    <div class="form-group full-width">
                        <label for="interviewNotes">Notas / Instruções para o candidato</label>
                        <textarea id="interviewNotes" placeholder="Ex: Por favor, tenha seu portfólio pronto para apresentar. O link para a chamada será enviado 15 minutos antes."></textarea>
                    </div>
                    <div class="form-group full-width" id="interview-link-group">
                        <label for="interviewLink">Link da Reunião / URL</label>
                        <textarea id="interviewLink" placeholder="Ex: Digite o link da url do teams ou meet"></textarea>
                    </div>
                    <div class="form-group full-width">
                        <label class="checkbox-container">Entrevista Presencial
                            <input type="checkbox" id="presential-interview">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div class="form-group full-width hidden" id="interview-address-group">
                        <label for="interviewAddress">Endereço e Informações do Local</label>
                        <textarea id="interviewAddress" placeholder="Ex: Rua Exemplo, 123, Bairro, Cidade - CEP. Ponto de referência: Próximo ao Senac."></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button class="btn btn-cancel" id="cancel-btn">Cancelar</button>
                <button type="button" class="btn btn-primary" id="save-interview-btn">Agendar e Enviar Convite</button>
            </div>
        </div>
    </div>
</body>
