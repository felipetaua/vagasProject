...
<head>
    ...
    <title>Criar Nova Vaga - Conexão RH</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    
    <link rel="stylesheet" href="../../../../../assets/css/pages/vagas/vagas.css">

    <script defer src="../../../../../assets/js/global/script.js"></script>
    <script defer src="../../../../../assets/js/global/auth-guard.js"></script>
    <script defer src="../../../../../assets/js/pages/vagas/vagas.js"></script>
</head>
<body>
    <div class="dashboard-container">
            ...
            <nav class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li class="menu-item-collapsible">
                        ...
                        <ul class="submenu">
                            <li><a href="./vagas.blade.php" class="submenu-item active">Criar vagas</a></li>
        ...
        <main class="main-content">
            ...
            <section class="page-header">
                ...
                <p>Preencha os detalhes abaixo para publicar uma nova oportunidade em seu portal de carreiras.</p>
            </section>
                ...
                <div class="form-column">
                    <form id="create-job-form">
                        <section class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group full-width">
                                    <label for="companyName">Nome/Razão Social</label>
                                    <input type="text" id="companyName" placeholder="Digite o nome ou razão social da empresa">
                                </div>
                                <div class="form-group full-width">
                                    <label for="companyDescription">Breve Descrição da Empresa</label>
                                    <textarea id="companyDescription" placeholder="Descreva brevemente a empresa"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="companyPhone">Telefone</label>
                                    <input type="tel" id="companyPhone" placeholder="Ex: (XX) XXXXX-XXXX">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="jobZipcode">CEP</label>
                                    <input type="text" id="jobZipcode" name="jobZipcode" required>
                                </div>
                                <div class="form-group">
                                    <label for="jobStreetName">Rua</label>
                                    <input type="text" id="jobStreetName" name="jobStreetName" required>
                                </div>
                                <div class="form-group">
                                    <label for="jobStreetNumber">Número</label>
                                    <input type="text" id="jobStreetNumber" name="jobStreetNumber">
                                </div>
                                <div class="form-group">
                                    <label for="jobDistrict">Bairro</label>
                                    <input type="text" id="jobDistrict" name="jobDistrict">
                                </div>
                                <div class="form-group">
                                    <label for="jobCity">Cidade</label>
                                    <input type="text" id="jobCity" name="jobCity" required>
                                </div>
                                <div class="form-group">
                                    <label for="jobState">Estado (UF)</label>
                                    <input type="text" id="jobState" name="jobState" maxlength="2" required>
                                </div>
                                <div class="form-group">
                                    <label for="jobCountry">País</label>
                                    <input type="text" id="jobCountry" name="jobCountry" value="Brasil" required>
                                </div>
                            </div>
                        </section>
                        <section class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group full-width">
                                    ...
                                    <input type="text" id="jobTitle" placeholder="Ex: Analista, Desenvolvedor, Vendedor, etc. ">
                                </div>
                                <div class="form-group">
                                    <label for="department">Departamento</label>
                                    <input type="text" id="department" placeholder="Ex: Tecnologia, Vendas, RH">
                                </div>
                                <div class="form-group">
                                    <label for="jobIcon">Categoria</label>
                                    <select id="jobIcon">
                                        ...
                                        <option value="agro">Agricultura</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="location">Localização</label>
                                    <input type="text" id="location" placeholder="Ex: Cidade, Estado ">
                                </div>
                                <div class="form-group">
                                    <label for="workModel">Modelo de Trabalho</label>
                                    <select id="workModel">
                        ...
                        <section class="form-section">
                            ...
                            <div class="form-group full-width">
                                <label for="jobDescription">Descrição Detalhada da Vaga</label>
                                <textarea id="jobDescription" placeholder="Fale sobre a vaga, a equipe e por que é um ótimo lugar para trabalhar..."></textarea>
                            </div>
                            <div class="form-group full-width">
                                <label for="jobActivities">Atividades Relacionadas ao Cargo</label>
                                <textarea id="jobActivities" placeholder="Liste as principais responsabilidades e atividades do cargo"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="workload">Carga Horária</label>
                                <input type="text" id="workload" placeholder="Ex: 40 horas semanais, Segunda a Sexta das 8h às 18h">
                            </div>
                            <div class="form-group">
                                <label for="benefits">Benefícios</label>
                                <textarea id="benefits" placeholder="Liste os benefícios oferecidos, Ex: Vale Transporte, Vale Refeição, Plano de Saúde"></textarea>
                            </div>
                            <div class="form-group full-width">
                                <label for="requiredSkills">Habilidades Requeridas</label>
                                <textarea id="requiredSkills" placeholder="Liste as habilidades técnicas e comportamentais necessárias"></textarea>
                            </div>
                        </section>
                        ...
                        <section class="form-section">
                            <h2>Remuneração</h2>
                            <div class="form-group full-width">
                                <label for="salary">Remuneração</label>
                                <div style="display: flex; align-items: center; gap: 1rem;">
                                    <input type="number" id="salary" name="salary" placeholder="Ex: 3500" min="0" step="any" style="flex:1;">
                                    <label style="display: flex; align-items: center; gap: 0.4em; font-size: 0.98em;">
                                        <input type="checkbox" id="salaryHidden" name="salaryHidden" style="accent-color: var(--primary-color);">
                                        Salário oculto
                                    </label>
                                </div>
                            </div>
                ...
                <aside class="preview-column">
                    ...
                    <article class="job-card">
                        <div class="job-header">
                            <div class="job-icon" id="previewIconContainer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
                            </div>
                            <div class="job-title">
                                <h3 id="previewTitle">Título da Vaga</h3>
                                <p id="previewDepartment">Departamento</p>
                            </div>
                        </div>
                        <div class="job-details">
                            <span id="previewLocationWrapper">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                <span id="previewLocation">Localização</span>
                            </span>
                            <span id="previewWorkModelWrapper">
                                ...
                                <span id="previewWorkModel">Modelo</span>
                            </span>
                        </div>
                        <p class="description" id="previewDescription">A descrição completa da vaga aparecerá aqui, mostrando um resumo para o candidato...</p>
                        <div class="job-footer">
                            <span class="job-salary" id="previewSalary">R$ 0,00 <span>/mês</span></span>
                            <a href="#" class="btn btn-secondary" style="pointer-events: none;">Ver Detalhes</a>
                        </div>
                    </article>
                </aside>
            </div>
