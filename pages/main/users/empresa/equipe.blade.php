...
<head>
    ...
    <title>Nossa Equipe - Conexão RH</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    
    <link rel="stylesheet" href="../../../../assets/css/pages/equipe/equipe.css">

    <script defer src="../../../../assets/js/global/script.js"></script>
    <script defer src="../../../../assets/js/pages/equipe/equipe.js"></script>
        ...
        <main class="main-content">
            ...
            <header class="page-header">
                ...
                <div class="page-actions">
                    <div class="search-bar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" x2="16.65" y1="21" y2="16.65"></line></svg>
                        <input type="text" placeholder="Buscar membro..." name="search" id="search">
                    </div>
                    <button class="btn btn-primary header-btn" id="add-member-btn">
            ...
            <div class="team-grid">
                <div class="member-card">
                    ...
                    <img src="https://i.pravatar.cc/150?img=68" alt="Foto de Ana Oliveira" class="member-avatar">
                    <div class="member-info">
                        <h3 class="member-name">Ana Oliveira <span class="status-dot online"></span></h3>
                        <p class="member-role">Gerente de RH</p>
                        <div class="member-meta">
                            <span><svg fill="currentColor" width="16" height="16" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg> ana.o@email.com</span>
                        </div>
                    </div>
                ...
                <div class="member-card">
                    <div class="card-header-bg"></div>
                    <img src="https://i.pravatar.cc/150?img=33" alt="Foto de Bruno Santos" class="member-avatar">
                    <div class="member-info">
                        <h3 class="member-name">Bruno Santos <span class="status-dot online"></span></h3>
                        <p class="member-role">Recrutador Sênior</p>
                        <div class="member-meta">
                            <span><svg fill="currentColor" width="16" height="16" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg> bruno.s@email.com</span>
                        </div>
                    </div>
                    <div class="member-actions">
                        <button class="btn btn-secondary">Ver Perfil</button>
                ...
                <div class="member-card">
                    <div class="card-header-bg"></div>
                    <img src="https://i.pravatar.cc/150?img=25" alt="Foto de Carla Costa" class="member-avatar">
                    <div class="member-info">
                        <h3 class="member-name">Carla Costa <span class="status-dot offline"></span></h3>
                        <p class="member-role">Analista de Recrutamento</p>
                        <div class="member-meta">
                            <span><svg fill="currentColor" width="16" height="16" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg> carla.c@email.com</span>
                        </div>
                    </div>
                    <div class="member-actions">
                        <button class="btn btn-secondary">Ver Perfil</button>
                ...
                <div class="member-card">
                    <div class="card-header-bg"></div>
                    <img src="https://i.pravatar.cc/150?img=15" alt="Foto de Daniel Ferreira" class="member-avatar">
                    <div class="member-info">
                        <h3 class="member-name">Daniel Ferreira <span class="status-dot online"></span></h3>
                        <p class="member-role">Gerente de Contratação (TI)</p>
                        <div class="member-meta">
                            <span><svg fill="currentColor" width="16" height="16" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg> daniel.f@email.com</span>
                        </div>
                    </div>
                    <div class="member-actions">
                        <button class="btn btn-secondary">Ver Perfil</button>
    ...
    <div class="modal-overlay" id="add-member-modal">
        <div class="modal-container">
            ...
            <div class="modal-body">
                <p>Insira os dados do novo membro para enviar um convite de acesso à plataforma.</p>
                <form>
                    <div class="form-group">
                        <label for="fullName">Nome Completo</label>
                        <input type="text" id="fullName" placeholder="Ex: Maria da Silva">
                    </div>
                    <div class="form-group">
                        <label for="email">E-mail de Trabalho</label>
                        <input type="email" id="email" placeholder="Ex: maria.silva@suaempresa.com">
                    </div>
                    <div class="form-group">
                        ...
                        <select id="role">
                            ...
                            <option value="gerente">Gerente de Contratação</option>
