...
<header style='background:white; margin-top:-10px; padding:5px;'>
    <ul>
        ...
        <a href='./profissionais.php'><li>Profissionais</li></a>
        <a href='./cadastroVagas.php'><li>Cadastrar vaga</li></a>
        <a href='./ultimasVagas.php'><li>Últimas vagas</li></a>
        <a href='./vagasCriadas.php'><li>Minhas vagas</li></a>
        <div class='dropdown'> 
            <div class='perfil-img' style='display:flex; align-items:center; justify-content:center;'>
                <div style='display:flex; flex-direction:column; align-items:center;'>
                    <?php if ($headerUser && !empty($headerUser['foto'])): ?>
                        <img src='../uploads/<?php echo htmlspecialchars($headerUser['foto']); ?>' style='width:50px; height:50px; border-radius:100%;' alt="Foto de perfil">
                    <?php else: ?>
                        <img src='https://placehold.co/50x50' style='width:50px; height:50px; border-radius:100%;' alt="Foto de perfil padrão">
                    <?php endif; ?>
                </div>    
            ...
            <ul class='dropdown-menu'>
                ...
                <a href='./profissao.php'> <li>Profissão</li></a>
                <a href='contratos.php'><li>Contratos</li></a>
                <a href='#'> <li>Chat</li></a>
